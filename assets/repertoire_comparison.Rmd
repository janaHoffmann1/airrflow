...
dat <- dat %>% dplyr::select(any_of(c("sample_id","ConvertDb-fasta", "AssignGenes-igblast", "MakeDB-igblast",
                                "FilterQuality","ParseDb-split", "FilterJunctionMod3","AddMetadata","SingleCellQC",
                                "RemoveContaminants","CreateGermlines","RemoveChimeric","CollapseDuplicates",
                                "ClonePass"))) %>% dplyr::arrange(sample_id)
...
tab_seqs_assembled <- tab_seqs_assembled %>%
        ...
        dplyr::filter( task %in% c("sample_id","AssignGenes-igblast", "MakeDB-igblast", "FilterQuality",
                                "ParseDb-split", "FilterJunctionMod3","AddMetadata","SingleCellQC","RemoveContaminants",
                                "CreateGermlines","RemoveChimeric","CollapseDuplicates","ClonePass"))
